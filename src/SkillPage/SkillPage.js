...
const item = [
  ...
  },
  {
    ...
    // #2654b98f
    mt: "mr-[550px] md:ml-[140px] top-[-180px] max-md:mr-[10px] max-md:top-[-430px] max-lg:mr-[500px]",
...
const SkillPage = () => {
  return (
    <div className="h-screen md:mt-[300px] max-md:mt-[50px]">
      <div className="grid grid-cols-5  max-md:grid-cols-1  overflow-hidden">
        ...
        <div className="grid grid-cols-3 max-md:grid-cols-1 lg:col-span-2 relative z-[9]  place-content-center place-items-center   w-full max-md:w-[100%] max-[390px]:grid-cols-1 mx-auto gap-x-[11rem]">
          {item.map((items, index) => (
            ...
            >
              <motion.div
                ...
                className={`example-container ${items.backgroundColor} rounded-[15px] ${items.w} ${items.h} w-[100%] h-[100%] px-5`}
              ></motion.div>
              <motion.div
