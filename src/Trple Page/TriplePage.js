                      ...
                      >
                        <motion.div>
                          <LazyLoadImage
                            ...
                            className={`${
                              LoadImg
                                ? "scale-[1.02] blur-xl grayscale delay-75 "
                                : "scale-100 blur-0 grayscale-0 delay-75"
                            } duration-700 ease-in-out w-[100%]  imgla h-auto max-w-xl`}
                          />
                        </motion.div>
                      </motion.div>
                      <div className="md:mt-[75px] mt-[30px] lg:mt-[70px] min-[629px]:mt-20 max-w-lg">
                        <CardHeader className="p-0 px-5 flex items-center pt-3">
                          <h1 className=" font-pop font-medium text-[16px]">
                            {project.name}
                          </h1>
                        </CardHeader>
                        <div>
                          ...
                          <CardFooter className="p-0 pt-3 pb-3 px-5 gap-2">
                            ...
                            />
                            {project?.svg && (
                              <div className="w-6">{project.svg}</div>
                            )}
                            {project?.svg2 && (
                              <div className="w-6">{project.svg2}</div>
                            )}
                            {project?.svg3 && (
                              <div className="w-6">{project.svg3}</div>
                            )}
                            {project.imgBuildTwo && (
                              <Image
                                alt="img"
